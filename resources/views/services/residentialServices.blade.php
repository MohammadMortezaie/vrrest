...
@section('header')
    <title>Resedintional Services </title>
@endsection
                ...
                <div class="col-12 col-lg-6 col-xl-7">
                    <div class="row justify-content-xl-center">
                        <div class="col-12 col-xl-11">
                            <h2 class="fs-1 fw-bolder">Commercial Services Cleanup & Repair</h2>
                            <hr>
                            <p class="lead mb-5">
        ...
        <div class="container">
            <div class="row gy-3 gy-md-4 gy-lg-0 ">
                <div class="col-12 mb-3">
                    ...
                    <p class="lead">
                        Commercial Services can strike at any time. Our SERVPRO team is always ready for your call with water
                        extraction services nearby because we understand time is of the essence when Commercial Servicess your
        ...
        <div class="container">
            <div class="row gy-3 gy-md-4 gy-lg-0 ">
                <div class="col-md-7 mb-3">
                    <h2 class="fs-2 fw-bolder">
                        Residential Water Extraction and Cleanup
                    </h2>

                    <p class="lead">
                        Our focus is restoring your affected space to pre-damaged condition. Rest assured, our
                        highly-trained technicians will complete the water removal and cleanup process from beginning to
                        end, helping to ensure it is documented along the way, and dried properly and thoroughly. Our
                        customer-focused professionals will:
                    </p>
                    <ul>
                        <li>
                            Assess your property's Commercial Services.
                        </li>
                        <li>
                            Explain the extent of the Commercial Services and the restoration process so you're able to make an
                            informed decision on how to proceed.
                        </li>
                        <li>
                            Use advanced equipment to detect hidden moisture and perform water extraction of any standing
                            water.
                        </li>
                        <li>
    ...
    <section class="py-3 py-md-5  bg-vr-second">
        <div class="container">
            <div class="row gy-3 gy-md-4 gy-lg-0 ">
                ...
                <div class="col-md-7 mb-3">
                    <h2 class="fs-2 fw-bolder">
                        Commercial Commercial Services Restoration
                    </h2>

                    <p class="lead">
                        When Commercial Services occurs in your commercial property, be it a small business, warehouse, high-rise
                        ...
                        size or source of the commercial job, from floods to broken pipes, our team of professionals is
        ...
        <div class="container">
            <div class="row gy-3 gy-md-4 gy-lg-0 ">
                <div class="col-md-12 mb-3">
                    <h2 class="fs-2 fw-bolder">
                        VR Restoration of Central Vancouver is Always Near You for Commercial Services Restoration Service
                    </h2>
                    <hr>
                </div>

                <div class="col-md-4 mb-3">
                    <div class="card bg-vr border-0 text-white mb-3 rounded">
                        <div class="card-header">
                            Highly Trained Restoration Specialists</div>
                        <div class="card-body">
                            <p class="card-text">
                                Our professionals specialize in residential Commercial Services restoration, with training focused
